const getPeliculas = async() => {
	...
	//if ( idx != 'cartelera' || idx != 'estreno' ) return; location.href = 'index.html'
            ...
            <div class="contenido-cartelera">
				<div class="datos-pelicula">
                    ...
                    <div class="boton-pelicula"> 
               		...
               		<div class="boton-pelicula"> 
               			<a href="youtube.html?id=${pelicula.Link}" target=_blank  onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" >
